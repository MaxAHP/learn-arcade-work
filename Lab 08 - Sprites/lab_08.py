...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        super().__init__(SCREEN_WIDTH, SCREEN_HEIGHT, "Coins galore")
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite(":resources:images/animated_characters/zombie/zombie_walk5.png", SPRITE_SCALING_PLAYER)
